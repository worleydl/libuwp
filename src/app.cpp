...
// todo: args/launcher support
// No frills app wrapper, provide your own main
extern "C" __declspec(dllexport) int uwp_main(int (*mainFunc)())
{
	UWPEntryPoint = mainFunc;
	auto appsrc = ref new  UWPApplicationSource();
	CoreApplication::Run(appsrc);
	return 0;
}
